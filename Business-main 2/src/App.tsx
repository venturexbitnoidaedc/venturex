  ...
  <div className="flow-timeline">
    ...
    <div className="flow-item">
      ...
      <div className="flow-card">
        ...
        <section id="prizes" className="prizes section-pad section-light"><div className="prize-heading"><SectionLabel>The reward</SectionLabel><h2>Ideas worth<br /><span>investing in.</span></h2><p>Bring the plan. Earn the platform. Take your first step toward BIT-NISHAN.</p></div><div className="prize-list"><div className="prize-card first"><span className="prize-place">01 / FIRST PRIZE</span><Trophy size={39} strokeWidth={1.2} /><b>₹21,000</b><small>For the boldest business plan</small></div><div className="prize-card second"><span className="prize-place">02 / SECOND PRIZE</span><Award size={35} strokeWidth={1.2} /><b>₹11,000</b><small>For a plan with momentum</small></div><div className="prize-card third"><span className="prize-place">03 / THIRD PRIZE</span><Target size={32} strokeWidth={1.2} /><b>₹5,000</b><small>For an idea with promise</small></div></div></section>
